...
async def start(_, message):
    buttons = [
        ...
        [
          InlineKeyboardButton("๏sᴜᴘᴘᴏʀᴛ ᴛᴇᴀᴍ๏", url="https://t.me/Team_x_t"),
    ...
    if command_parameter == "help":
        ...
        await message.reply_photo(
            photo="https://telegra.ph/file/39f0b939c9ac5af118311.jpgg",
            caption=start_txt,
...
async def callback_query_handler(_, query):
    if query.data == 'close_data':
        ...
        buttons = [
            ...
            [
              InlineKeyboardButton("๏sᴜᴘᴘᴏʀᴛ ᴛᴇᴀᴍ๏", url="https://t.me/Team_xt_support"),
              InlineKeyboardButton("๏ᴍʏ ᴅᴇᴠʟᴏᴘᴇʀ๏", user_id=config.OWNER_ID)
            ],
            [
              InlineKeyboardButton("๏ʙᴏᴛ ғᴇᴀᴛᴜʀᴇs๏", callback_data="settings_back_helper"),
